...
//Again really hard to follow. it's spaghetti code that i am sure works but it's hard for no reason.
//Better function design would help this look much better 
